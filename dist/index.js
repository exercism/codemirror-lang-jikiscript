...
const parser = LRParser.deserialize({
  ...
  nodeNames: "⚠ LineComment Program FunctionDefinition Identifier function Body do end with VariableDefinition set to BinaryExpression EqualityExpression PrimaryExpression Boolean String Integer Floating is equals == RelationalExpression > < >= <= VariableReassignment change RepeatStatement repeat times RepeatUntilGameOverStatement IfStatement if ElseStatement else ReturnStatement return ExpressionStatement",
  maxTerm: 52,
  skippedNodes: [0,1],
  repeatNodeCount: 2,
    ...
    parser: parser.configure({
        props: [
            styleTags({
                ...
                Floating: tags.float,
                "do end": tags.keyword,
                "set change to": tags.keyword,
                "function with": tags.definitionKeyword,
                "repeat repeat_until_game_over times": tags.keyword,
                "if else": tags.keyword,
                "is equals": tags.keyword,
                "return": tags.keyword,
